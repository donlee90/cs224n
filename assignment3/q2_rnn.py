...
class Config:
    ...
    def __init__(self, args):
        ...
        self.eval_output = self.model_path + "results.txt"
        self.conll_output = self.model_path + "{}_predictions.conll".format(self.cell)
        self.log_output = self.model_path + "log"
    ...
    for sentence, labels in data:
        ...
        for i in xrange(max_length):
            if i < len(sentence):
                ...
                mask.append(False)
                padded_sentence.append(zero_vector)
                padded_labels.append(zero_label)
...
class RNNModel(NERModel):
    ...
    def add_placeholders(self):
        ...
        self.input_placeholder = tf.placeholder(tf.int32, [None, max_length, n_features])
        self.labels_placeholder = tf.placeholder(tf.int32, [None, max_length])
        self.mask_placeholder = tf.placeholder(tf.bool, [None, max_length])
    ...
    def add_prediction_op(self):
        ...
        ### YOUR CODE HERE (~4-6 lines)
        U = tf.get_variable("U", [Config.hidden_size, self.config.n_classes],
